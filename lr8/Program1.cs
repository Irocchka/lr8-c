...
namespace Lab_08_02
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            //поиск в выбранном каталоге и во всех его подкаталогах
            ...
            File.Delete("C:/Users/79526/source/repos/lr8/lr8/archive.zip");
            using (var archive = ZipFile.Open("C:/Users/79526/source/repos/lr8/lr8/archive.zip", ZipArchiveMode.Create))
            {
